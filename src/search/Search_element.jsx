...
//     return () => {
//       clearTimeout(timerId); // Очистка таймера, если компонент размонтируется или searchTerm изменится раньше времени
//     };
//   }, [searchTerm]);

//   useEffect(() => {
//     if (debouncedSearchTerm) {
//       console.log("Отправка запроса с:", debouncedSearchTerm);
//       // Здесь отправляйте запрос на сервер с debouncedSearchTerm
//     }
//   }, [debouncedSearchTerm]);
  ...
  return (
    <div className={cl.search_block} onClick={handleBlockClick}>
      ...
      <input
        ...
        ref={inputRef}
      />
      {/* Используем отдельный компонент для подсказок */}
